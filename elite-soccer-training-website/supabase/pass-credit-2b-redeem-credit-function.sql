...
-- Step 2B: Function that redeems one paid Launch Pass credit into a confirmed booking.
-- Run after pass-credit-1-tables.sql and pass-credit-2a-confirm-pass-function.sql.
