    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <CustomPaymentLinkForm
        link={{
          ...
          privateSessionAmountCents: details.link.private_session_amount_cents ?? 0,
          allowedPurchaseOptions: details.link.allowed_purchase_options ?? [],
          selectedPlanType: details.link.selected_plan_type ?? null,
          selectedAmountCents: details.link.selected_amount_cents ?? null,
          selectedTotalCredits: details.link.selected_total_credits ?? null,
